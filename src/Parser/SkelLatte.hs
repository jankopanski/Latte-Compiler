...
transTopDef x = case x of
  ...
  ClsDef _ ident fields -> failure x
...
transStmt x = case x of
  ...
  Ass _ vars expr -> failure x
  ArrAss _ ident expr1 expr2 -> failure x
...
transExpr x = case x of
  ...
  EAccArr _ ident expr -> failure x
  ENewCls _ ident -> failure x
  ENull _ ident -> failure x
