...
instance Print (TopDef a) where
  prt i e = case e of
    ...
    ClsDef _ id fields -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id, doc (showString "{"), prt 0 fields, doc (showString "}")])
...
instance Print (Field a) where
  prt i e = case e of
    Field _ type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ";"), prt 0 xs])
instance Print (Var a) where
  prt i e = case e of
    Var _ id -> prPrec i 0 (concatD [prt 0 id])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString "."), prt 0 xs])
...
instance Print (Stmt a) where
  prt i e = case e of
    ...
    Ass _ vars expr -> prPrec i 0 (concatD [prt 0 vars, doc (showString "="), prt 0 expr, doc (showString ";")])
    ArrAss _ id expr1 expr2 -> prPrec i 0 (concatD [prt 0 id, doc (showString "["), prt 0 expr1, doc (showString "]"), doc (showString "="), prt 0 expr2, doc (showString ";")])
...
instance Print (Expr a) where
  prt i e = case e of
    EVar _ vars -> prPrec i 6 (concatD [prt 0 vars])
    ...
    EAccArr _ id expr -> prPrec i 6 (concatD [prt 0 id, doc (showString "["), prt 0 expr, doc (showString "]")])
    ENewCls _ id -> prPrec i 6 (concatD [doc (showString "new"), prt 0 id])
    ENull _ id -> prPrec i 6 (concatD [doc (showString "("), prt 0 id, doc (showString ")"), doc (showString "null")])
