...
data Field a = Field a (Type a) Ident
  deriving (Eq, Ord, Show, Read)
...
instance Functor Stmt where
    fmap f x = case x of
        ...
        Ass a vars expr -> Ass (f a) (map (fmap f) vars) (fmap f expr)
...
instance Eq (Type e) where
  ...
  Cls _ ident1 == Cls _ ident2 = ident1 == ident2
...
instance Functor Expr where
    fmap f x = case x of
        EVar a vars -> EVar (f a) (map (fmap f) vars)
        ...
        ENewCls a ident -> ENewCls (f a) ident
